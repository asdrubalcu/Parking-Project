...
class EspaciosParqueo:
    ...
    # Método para actualizar (reiniciar) espacios según configuración actual
    def actualizar_espacios(self):
        # Guarda las placas que estaban ocupando espacios antes del cambio, para poder darles salida.
