...
# Esta clase gestiona la cola de espera para autos y sus espacios (e1, e2, e3) predefinidos
class ColaEspera:
    def __init__(self):
        # Lista que guarda instancias de Vehiculo en orden FIFO
        self.cola_espera_autos = []
        # Diccionario de espacios para la cola con claves e1..e3
    ...
    # Sacar primer vehículo de la cola, y liberar espacio cola
